...
const cubeTweak = gui.addFolder("cucumberNetes");
// cubeTweak.close();

cubeTweak.add(mesh.position, "y").min(-2).max(2).step(0.01).name("elevation");
cubeTweak.add(mesh, "visible");
cubeTweak.add(material, "wireframe");
cubeTweak.addColor(debugObject, "color").onChange((value) => {
